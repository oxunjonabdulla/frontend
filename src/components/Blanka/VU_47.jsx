...
import { vu_47, vu_90 } from "../../utils/mock_heads";
import { VU_90_Model } from "./Modals/VU_90_Model";
import { VU_47_Model } from "./Modals/VU_47_Model";
const data = [0];
export const VU_47 = () => {
  ...
  return (
    ...
    >
      ...
      <VU_47_Model isOpen={isOpen} onClose={onClose} />
    </Box>
  );
};
