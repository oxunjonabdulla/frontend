...
export const routersSidebar = [
    ...
    },
    {
        ...
        accordItems: [
            ...
            {
                label: "Rezervuar, tormoz silindr va ishchi kameralarni ro'yxatga olish kitobi",
...
export const vu_22_assabmle_options = [
    ...
    "Gayka M 16",
    "Metall qoplama",
    "Zahira sig'imi tutqichi",
    "Gayka M 22",
    "So'ngi jumrak tutqichi, shaybasi",
    "Eshik upori/Eshik parogi",
    "Asosiy havo quvuri tutqichi",
    "Eshik soyaboni",
    "Poyezd tuzuvchining zinapoyasi/Poy.tuz tutqichi",
    "Sremyanka",
    "Eshikning buzilishi",
    "Klin shayba , shplint",
    "Yarim vagon valigi/Yarim vagon vtulkasi",
    "Muhofaza tutqichi -",
    "Qo'l tormozi tyagasi",
    "Qo'l rejimi -",
    "GSP ko'rsatkichi",
    "A o'lcham vinti va gaykasi",
    "Tushirish lyuki saqlagichi",
    "Dastakli uzatgichni to'g'irlash",
    "Poyezd tuzuvchining tutqichi",
    "Qo'l boshmog'i -",
    "Old ustun",
    "Tushurish lyuklarini buzilishi",
    "To'g'irlash -",
    "Bortlar buzilishi",
    "Kuzuv bog'lamasini payvandlash",
    "Yon ustun",
    "Zarba so'ndiruvchi",
    "Eshik buzilishi/yon tomon",
    "Burchak ustuni",
    "Old uporni payvandlash/orqa uporni payvandlash",
    "Quvvatlantiruvchi-ustun metalini payvandlash",
    "Uzish richag zanjirini payvandlash",
    "Ta'mirlanmoqda",
    "Xavfsizlik probkasi",
    "Gorizontal",
    "Tormoz uzatmasini  yechish",
    "Yon taxtalarni saralash",
    "Pol taxtalarini saralash",
...
export const vu_22_avtobirikma_options = [
    "Avtobrikma boshi",
    "Avtobrikma qulfi/qulf ushlagich",
    "Qulf saqlagichi/qulf ko'targichi",
    "Ko'targich valigi",
    "So'ndiruvchi apparat",
    "Tortuvchi xamut",
    "Markazlovchi balichkalar",
    "Mayatnikli osma",
    "Tortuvchi xamut ponasi",
    "Ko'maklanturuvchi planka/upor plitasi"
]
...
export const vu_53_form_second2 = [
    [
        ...
        {
            label: "G`ildirak juftligining yurish qismini qayta tiklangankbr sababi (klassifikator bo`yicha nosozlik raqami)",
            rowspan: 5
        },
    ...
    [
        ...
        {
            label: "Greben qismi payvandlangandan so`ng  g`ildirak juftligining  yurish qismini  qayta tiklangan",
            rowspan: 4
        },
